...
export const NavigationSection = (): JSX.Element => {
  ...
  return (
    <header
      className="flex w-full h-[88px] items-center justify-between px-6 py-5 bg-[#0000001a] backdrop-blur-[2px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(2px)_brightness(100%)] sticky top-auto right-auto bottom-auto left-auto"
      data-oid="2z4a_e8"
    >
